...
const MonthDummy = () => {
	return (
		<>
			{/* NAVBAR*/}
			<nav className="flex justify-end px-5 py-2 bg-white shadow">
				<button className="flex items-center justify-center bg-gray-100 rounded-full px-3 py-1 m-2 shadow-lg text-xs">
					<HomeRoundedIcon className="w-4 h-4 mr-1" />
        ...
        <div className="w-5/6 my-8 border-4 border-gray-900">
          <div className="w-auto h-full border-4 border-orange-500">
            <h1>Hello World!</h1>
				...
				<footer className="w-full h-16 border-red-300 flex justify-end px-5 py-2 mt-8 bg-white shadow">
					<div>
						<label className="font-bold mr-3 text-lg">
